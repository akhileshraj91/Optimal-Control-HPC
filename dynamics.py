...
def x_dot(X, t, a, b):
    ...
    phi_1 = np.array([x_1**2,x_1*x_2,x_1*x_3,x_2**2,x_2*x_3,x_3**2])
    del_phi_1 = np.array([[2*x_1,0,0],[x_2,x_1,0],[x_3,0,x_1],[0,2*x_2,0],[0,x_3,x_2],[0,0,2*x_3]])
...
# W1_hat = np.array([[1.42],[1.612],[-0.1366],[1.4462],[-0.1480],[0.4317]]).ravel()
# W2_hat = np.array([[1.42],[1.612],[-0.1366],[1.4462],[-0.1480],[0.4317]]).ravel()
...
x = odeint(x_dot, initial_value, t, args=(A, B))
W1_data = x[:,3:9]
W2_data = x[:,9:15]
print(W1_data[0,:],'\n',W1_data[-1,:])
print(W2_data[0,:],'\n',W2_data[-1,:])
