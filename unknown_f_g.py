...
def x_dot(X, t):
    ...
    phi_x = np.array([x[0]**2,x[1]**2,x[0]*x[1],x[0]**4,x[1]**4,x[0]**3*x[1],x[0]**2*x[1]**2,
                      x[0]*x[1]**3,x[0]**6,x[1]**6,x[0]**5*x[1],x[0]**4*x[1]**2,x[0]**3*x[1]**3,
                      x[0]**2*x[1]**4,x[0]*x[1]**5,x[0]**8,x[1]**8,x[0]**7*x[1],x[0]**6*x[1]**2,
                      x[0]**5*x[1]**3,x[0]**4*x[1]**4,x[0]**3*x[1]**5,x[0]**2*x[1]**6,x[0]*x[1]**7]).T
    delphi = np.array([x[0],x[1],x[0]**3,x[1]**3,x[0]**2*x[1],x[0]*x[1]**2,
                      x[0]**5,x[1]**5,x[0]**4*x[1],x[0]**3*x[1]**2,x[0]**2*x[1]**3,
                      x[0]*x[1]**4,x[0]*x[1]**5,x[0]**8,x[1]**8,x[0]**7*x[1],x[0]**6*x[1]**2,
                      x[0]**5*x[1]**3,x[0]**4*x[1]**4,x[0]**3*x[1]**5,x[0]**2*x[1]**6,x[0]*x[1]**7]).T
    ...
    print(">>>>>",V_hat)
    x1_dot = p[0]*x[0]+p[1]*x[1]+p[2]*x[0]*(x[0]**2+x[1]**2)
    x2_dot = p[3]*x[0]+p[4]*x[1]+p[5]*x[1]*(x[0]**2+x[1]**2)
...
W1_hat = 1*np.random.rand(24,1).ravel()
W2_hat = 1*np.random.rand(24,1).ravel()
